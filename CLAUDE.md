...
- **1.05 is published and tagged `v1.05`** (2026-09-14): phase gate arrows on the commander's and
  ...
  while they show), and CBM's SMG blips in blue. **1.06 is the glyph refresh alone, on
  `feature/glyph-refresh`** (see "1.06 glyph refresh" at the end of this file); a slide repolish may
